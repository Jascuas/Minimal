@extends('layouts.master') @section('tittle') Home @endsection @section('content')
...
<section class="magazine-section my-5">
    ...
    <!-- Section description -->
    <p class="text-center dark-grey-text w-responsive mx-auto mb-5">Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint
    ...
    <div class="row">
        ...
        <div class="col-lg-6 col-md-12">
            ...
            <div class="single-news mb-4">
                ...
                <div class="news-data d-flex justify-content-between">
                    <a href="#!" class="light-blue-text">
                        <h6 class="font-weight-bold">
                            <i class="fa fa-plane pr-2"></i>Travels</h6>
                    </a>
                    <p class="font-weight-bold dark-grey-text">
                        <i class="fa fa-clock-o pr-2"></i>20/08/2018</p>
                </div>
                ...
                <p class="dark-grey-text">Nam libero tempore, cum soluta nobis est eligendi optio cumque nihil impedit quo minus id quod maxime placeat
            ...
            <div class="single-news mb-4">
                ...
                <div class="news-data d-flex justify-content-between">
                    <a href="#!" class="pink-text">
                        <h6 class="font-weight-bold">
                            <i class="fa fa-home pr-2"></i>Lifestyle</h6>
                    </a>
                    <p class="font-weight-bold dark-grey-text">
                        <i class="fa fa-clock-o pr-2"></i>24/08/2018</p>
                </div>
                ...
                <p class="dark-grey-text">Sed ut perspiciatis unde voluptatem omnis iste natus error sit voluptatem accusantium doloremque laudantium,
